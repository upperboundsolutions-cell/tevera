...
@section('content')
<section class="executive-banner dashboard-banner"><div><span class="hero-kicker">TEVERA / FLEET COMMAND</span><h2>Your fleet.<br>A clearer perspective.</h2><p>Track movement, review journeys and manage your fleet from one workspace.</p><div class="heading-actions"><a class="primary" href="{{ route('tracking') }}">Open vehicle map →</a>@can('manage-fleet')<a class="hero-link" href="{{ route('assistant.index') }}">Explore fleet assistant ✦</a>@endcan</div></div><div class="hero-emblem" aria-hidden="true">@include('partials.icon', ['name' => 'signal'])<span>TEVERA</span><small>ALWAYS AHEAD</small></div></section>
